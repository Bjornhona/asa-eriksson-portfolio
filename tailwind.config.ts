  ...
  theme: {
    extend: {
      colors: {
        ...
        brown: {
          200: "hsl(var(--color-brown-200) / <alpha-value>)",
        ...
        glowChar: "hsl(var(--glow-char) / <alpha-value>)",
        glowCharAdjacent: "hsl(var(--glow-char-adjacent) / <alpha-value>)",
        glowInner: "hsl(var(--glow-inner) / <alpha-value>)",
