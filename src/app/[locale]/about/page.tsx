...
const AboutPage = () => {
  ...
  return (
    <div className="relative container pt-[64px] pb-12">
      <motion.div
        className="absolute right-0 w-[40vw] h-[40vw] aspect-square overflow-hidden rounded-full ml-auto z-0"
        variants={fadeInUp}
        initial="initial"
        animate="animate"
      >
      ...
      >
        <motion.h6 variants={fadeInUp}>
          ...
          <strong>product design and frontend engineering</strong>, I’d love to
      ...
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <motion.h3 variants={fadeInUp}>My long experience counts on</motion.h3>
        <motion.h6 variants={fadeInUp}>
